# ITAI Machine Learning Labs
This folder contains my lab assignments for ITAI 1371. The lab cover Pyhton programming, data analysis, machine learning concepts, model evaluation, hyperparameter tuning, fairness in machine learning, and machine learning pipelines. 
...
## What I Learned
Through these labs, I learned how to load data, explore it, prepare it, train machine learning models, and check how well they work. I also learned that accuracy is not the only thing that matters. It is also important to understand model mistakes, avoid data leakage, and check if the model is fair for different groups.
